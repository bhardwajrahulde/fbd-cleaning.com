/**
 * =========================================================================
 * FBD CLEANING - FOUNDERS' SOCIAL LINKS & EMAIL CONFIGURATION
 * =========================================================================
 * 
 * Instructions:
 * You can edit this file in Notepad (or any text editor) to change the links 
 * for Instagram, LinkedIn, and Email for both Rahul and Sparsh.
 * 
 * Guidelines:
 * 1. Keep the quote marks around your links. E.g. "https://instagram.com/fbd.cleaning"
 * 2. Keep the commas at the end of each line.
 * 3. Save the file after making changes. The website will update instantly!
 */

const FOUNDERS_CONTACT = {
